...
Eventbrite.prototype = {
  ...
  'utils': {
    ...
    'eventListRow': function( evnt ){
      ...
      console.log(evnt)
      html = '<li class="span3"><a href="' + evnt.url + '" class="thumbnail"></a><div class="tag">'+
             '<img src="/assets/eventbritetag.png" alt="Eventbritetag"></div><div class="event_logo_cl"><img src="'+evnt.logo+'"></div>'+
             '<div style="clear:both"></div><div class="event_data_cl" ><h4>'+ evnt.title + '</h4><p class="ev_info"> '+evnt.organizer.description.substr(0,100)+'</p><p><i class="icon-calendar"></i> '+date_string +' '+time_string+'</p>'+
             '<p><i class="icon-map-marker"></i> '+ venue_name +'</p></li></div>';
      // html = "<img src="+evnt.logo+"><div class='eb_event_list_item' id='evnt_div_" + evnt.id + "'>" + 
